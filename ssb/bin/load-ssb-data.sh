...
##############################################################
# This script is used to load generated ssb data set to MatrixOne
...
run_sql "load data local infile '${SSB_DATA_DIR}/part.tbl' INTO TABLE part FIELDS TERMINATED BY '|' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '|\n';"

echo 'Loading data for table: date'
run_sql "load data local infile '${SSB_DATA_DIR}/date.tbl' INTO TABLE dates FIELDS TERMINATED BY '|' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '|\n';"

echo 'Loading data for table: supplier'
run_sql "load data local infile '${SSB_DATA_DIR}/supplier.tbl' INTO TABLE supplier FIELDS TERMINATED BY '|' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '|\n';"

echo 'Loading data for table: customer'
run_sql "load data local infile '${SSB_DATA_DIR}/customer.tbl' INTO TABLE customer FIELDS TERMINATED BY '|' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '|\n';"

echo "Loading data for table: lineorder, with ${PARALLEL} parallel"
function load() {
    echo "$@"
    run_sql "load data local infile '$@' INTO TABLE lineorder FIELDS TERMINATED BY '|' OPTIONALLY ENCLOSED BY '\"' LINES TERMINATED BY '|\n';"
}
