...
##############################################################
# This script is used to create TPC-C tables
##############################################################
...
echo "Run SQLs from ${CURDIR}/../ddl/create-tpcc-tables.sql"
mysql -h"${HOST}" -u"${USER}" -P"${PORT}" -D"${DB}" <"${CURDIR}"/../ddl/create-tpcc-tables.sql

echo "tpcc tables has been created"
